...
const postProduct = async (req, res) => {
  if (req.file) {
    ...
    try {
      ...
      created(res, `post product ${req.body.name} berhasil`, data);
    } catch (error) {
  ...
  if (req.file) {
    ...
    try {
      ...
      if (!existsSync(pathImage)) {
        ...
        return ok(res, `update produk ${result.name} berhasil`, result);
      }
...
module.exports = { getProducts, getSingleProduct, updateProduct, postProduct, deleteProduct };
