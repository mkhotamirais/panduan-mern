...
import { getUsers, updateUser } from "../../../../app/features/eduwork/edwUserSlice";
...
const EdwUserUpdate = () => {
  ...
  const { id } = useParams();
  const item = useSelector((state) => state.mdV2User.data.find((s) => s._id.toString() === id));
