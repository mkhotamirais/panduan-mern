...
import { getProducts, postProduct } from "../../../../app/features/mongodb/mdV1ProductSlice";
import { Button, Input, InputRef, Label, Textarea } from "../../../../components/Tags";
import { PiSpinner } from "react-icons/pi";

const MdV1ProductPost = () => {
  const dispatch = useDispatch();
  const navigate = useNavigate();

  const { status } = useSelector((state) => state.mdV1Product);
...
export default MdV1ProductPost;
